...
import { IMPORT_DIEMS_GV, SET_ERRORS, UPDATE_SCORE } from "../../../redux/actionTypes";
import { useDispatch, useSelector } from "react-redux";
import * as classes from "../../../utils/styles";
import React, { useEffect, useState } from "react";
import ReactModal from "react-modal";
import Spinner from "../../../utils/Spinner";
import { exportDiem, getCourseTeacherKHM, getScoreCourse, importDiem, updateScore } from "../../../redux/actions/teacherActions";
...
const Body = () => {
    ...
    useEffect(() => {
        if (valueMKH) {
            dispatch(getCourseTeacherKHM(user?.retObj?.userDetails?.username, valueMKH));
        }
    }, [valueMKH]);

    const coursesbykhnmagv = useSelector((state) => state?.teacher?.coursesbykhnmagv.retObj);
