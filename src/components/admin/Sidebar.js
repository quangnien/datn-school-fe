    ...
    <div className="flex-[0.2] w-[268px] h-full">
      <div className="ml-1  pt-4 space-y-8  h-full bg-[#04605E]">
        ...
        <div className="" style={{ marginTop: 0 }}>
          ...
          {/* sidebar student */}
          {users[users.indexOf("MENU_PROFILE_SV")] && (
            <NavLink
          ...
          {users[users.indexOf("MENU_STUDENT_SCORE")] && (
            <NavLink
              to="/student/score"
              className={({ isActive }) =>
                isActive ? isActiveStyle : isNotActiveStyle
          ...
          {users[users.indexOf("MENU_STUDENT_TKB")] && (
            <NavLink
              to="/student/tkb"
              className={({ isActive }) =>
                isActive ? isActiveStyle : isNotActiveStyle
          ...
          {users[users.indexOf("MENU_STUDENT_DKM")] && (
            <NavLink
              to="/student/dangkymon"
              className={({ isActive }) =>
                isActive ? isActiveStyle : isNotActiveStyle
              }
            >
          ...
          {/* teacher */}
          {users[users.indexOf("MENU_TEACHER_PROFILE")] && (
            <NavLink
              to="/teacher/profile"
              className={({ isActive }) =>
                isActive ? isActiveStyle : isNotActiveStyle
